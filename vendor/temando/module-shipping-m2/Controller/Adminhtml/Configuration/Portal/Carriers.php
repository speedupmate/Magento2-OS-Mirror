...
/**
 * Shipping Portal Carriers Redirect
 *
 ...
 */
class Carriers extends Action implements HttpGetActionInterface
{
    /**
    ...
    /**
     * Redirect user to Shipping Portal carriers.
     *
    ...
    {
        try {
            $redirectUrl = $this->portalUrl->getCarriersUrl();
